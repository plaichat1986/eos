...
namespace eosiosystem {
   ...
   struct producer_info {
      account_name          owner; //The account to register as a producer (required)
      double                total_votes = 0;
      eosio::public_key     producer_key; // a packed public key object. The producer's public key (required)
      bool                  is_active = true;
