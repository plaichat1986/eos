...
extern "C" {
  ...
  /**
   ...
   /**
    * Proposes a schedule change, once the block that contains the proposal becomes irreversible(不可逆的),
    * the schedule is promoted to "pending" automatically. Once the block that promotes the schedule is irreversible,
    * the schedule will become "active"
